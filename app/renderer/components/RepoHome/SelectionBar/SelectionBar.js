...
class SelectionBar extends Component {
  ...
  displayModel() {
    ...
    if (this.state.isCurrentRepoOpen)
      return (
        <CurrentRepoDialog
          openStatus={this.state.isCurrentRepoOpen}
          close={this.handleClickCloseCurrentRepo}
        />
      );
    else if (this.state.isCurrentBranchOpen)
      return (
        <CurrentBranchDialog
          openStatus={this.state.isCurrentBranchOpen}
          close={this.handleClickCloseCurrentBranch}
          message={obj}
        />
      );
      ...
      return (
        <PublishBranchDialog
          openStatus={this.state.isPublishBranchDialogOpen}
          close={this.handleClickClosePublishDialog}
          message={obj}
        />
      );
    else return null;
            ...
            <Toolbar variant="dense" disableGutters={true}>
              ...
              <AppBarButton color="inherit" onClick={this.handleClickOpenPublishDialog}>
                ...
                <span style={{ color: 'white' }}>
                  Publish{' '}
                  {this.state.currentBranchName ? this.state.currentBranchName : 'repository'}
                </span>
              </AppBarButton>
            </Toolbar>
          </AppBar>
